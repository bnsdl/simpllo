...
<body>
  ...
  <div id='infoPatchwork'>
    Dans cette partie, vous pouvez classer vos projets afin de les passer en type 'patchwork'. Ce dernier vous permet de déplacer et épingler vos listes selon vos envies !
  </div>
  <div class="container_flex">
    ...
    <div class='dropzone' style="background:#f2a339">
      ...
      <div id='dropper3' onmouseover="showInfos()"class="dropzone" style='background:rgb(50, 240, 103)'><h3>Patchworks</h3>
        <?php
...
function showInfos(){
  var infoPatch = document.getElementById("infoPatchwork");
  infoPatch.style.visibility = "inherit";
}
</script>
</html>
